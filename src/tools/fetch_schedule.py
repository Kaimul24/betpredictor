...
params = {
            ...
            'endDate': '04/13/2021',
            'hydrate': 'team,roster,weather,linescore(matchup,runners),statusFlags,venue(timezone,location),person,probablePitcher,stats,seriesStatus(useOverride=true)'
}
...
params = {
            ...
            'endDate': '04/01/2021',
            'hydrate': 'stats,team,weather,statusFlags,venue(timezone,location),probablePitcher'
}
...
venue = venue_info['name']
venue_id = venue_info['id']
venue_elevation = venue_info['elevation']
venue_azimuth_angle = venue_info['azimuthAngle']
venue_timezone = venue_info['timeZone']['tz']
venue_gametime_offset = venue_info['timeZone']['offsetAtGameTime']
...
home_team_name = away_team['team']['name']
home_pitcher = home_team['probablePitcher']
home_win_pct = home_team['leagueRecord']['pct']
"""