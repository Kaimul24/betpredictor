...
class BattingFeatures(BaseFeatures):
    ...
    def rolling_batting_stats(self) -> DataFrame:
        ...
        prior_specs = {
            ...
            "prior_iso":             ("iso",            "ab"),
            "prior_k_percent":       ("k_percent",     "pa"),
            "prior_bb_percent":      ("bb_percent",     "pa"),
            "prior_bb_k":            ("bb_k",           "pa"), 
        ...
        ewm_cols = {
            ...
            "k_percent":        ("k_percent", 'pa', "prior_k_percent",           150, True),
            "bb_percent":       ("bb_percent", 'pa', "prior_bb_percent",         150, True),
